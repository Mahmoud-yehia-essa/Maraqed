...
class DownloadPhoto2 extends Command
{
    protected $signature = 'photos2:download';
    protected $description = 'Download photos2 images from a JSON list';
