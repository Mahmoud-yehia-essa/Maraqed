				...
				<div class="row g-0">
					...
					<div class="col-12 col-xl-7 col-xxl-8 auth-cover-left bg-gradient-cosmic align-items-center justify-content-center d-none d-xl-flex">
						<div class="card shadow-none bg-transparent shadow-none rounded-0 mb-0">
							<div class="card-body">
                                 <img src="{{ asset('backend/assets/images/login-images/logo_m_new.png') }}" class="img-fluid" width="400" alt=""/>
							</div>
						</div>
					</div>
							...
							<div class="card-body p-sm-5">
								<div class="">
									<div class="mb-3 text-center">
										<img src="{{ asset('backend/assets/images/logo_mraqed.png') }}" width="100" alt="">
									</div>
									<div class="text-center mb-4">
										<h5 class="">لوحة تحكم - تطبيق مراقد</h5>
